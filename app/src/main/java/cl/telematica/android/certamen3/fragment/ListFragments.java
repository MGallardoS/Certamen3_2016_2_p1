 ...
 * {@link ListFragments.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ListFragments#newInstance} factory method to
...
public class ListFragments extends Fragment {
     ...
     *
     * @return A new instance of fragment ListFragments.
     */
    // TODO: Rename and change types and number of parameters
    public static ListFragments newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MyAsyncTaskExecutorImp.getInstance().executeMyAsynctask((MainActivity) this.getContext(), mRecyclerView);
